...
const ProfessionalInfoServices = ({ service }) => {
  return (
    <div className="w-[250px] h-[333px] md:w-[330px] md:h-[373px] bg-darkblue border-2 border-lightblue rounded-lg font-roboto">
      ...
      <div className="w-[90%] mx-auto">
        ...
        <div className="text-sm grid gap-1">
          ...
          <div>
            <h5>Description</h5>
            <div className="overflow-y-auto h-[90px] w-[295px] italic text-gray-300 break-words">
              {service.description}
            </div>
          </div>
        </div>
...
export default ProfessionalInfoServices;
